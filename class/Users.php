...
class Users extends Database { 
	...
	public function login(){		
		...
		if(!empty($_POST["login"]) && $_POST["email"]!=''&& $_POST["password"]!='') {	
			...
			$errorMessage = "Digite usuário e senha!";	
		}
		return $errorMessage; 		
	}
	...
	public function listUser(){
		...
		while( $user = mysqli_fetch_assoc($result) ) {		
			...
			if($user['user_type'] == 'admin')	{
				...
				$userRole = '<span class="label label-warning">Membro</span>';
			}	
			...
			$userRows[] = '<button type="button" name="delete" id="'.$user["id"].'" class="btn btn-danger btn-xs delete">Deletar</button>';
			$userData[] = $userRows;
		}
		$output = array(
