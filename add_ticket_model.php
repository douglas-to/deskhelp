		...
		<form method="post" id="ticketForm">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h4 class="modal-title"><i class="fa fa-plus"></i> Adicionar Ticket</h4>
				</div>
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<select id="department" name="department" class="form-control" placeholder="Departamento...">					
					...
					<div class="form-group">
						...
						<label class="radio-inline">
							<input type="radio" name="status" id="open" value="0" checked required>Aberto
						</label>
						<?php if(isset($_SESSION["admin"])) { ?>
							<label class="radio-inline">
								<input type="radio" name="status" id="close" value="1" required>Fechado
							</label>
						<?php } ?>	
					</div>
				</div>
