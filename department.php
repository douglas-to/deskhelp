	...
	<div class="panel-heading">
		<div class="row">
			...
			<div class="col-md-2" align="right">
				<button type="button" name="add" id="addDepartment" class="btn btn-success btn-xs">Adicionar Novo</button>
			</div>
		</div>
	</div>
			...
			<form method="post" id="departmentForm">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h4 class="modal-title"><i class="fa fa-plus"></i> Adicionar Departamento</h4>
					</div>
